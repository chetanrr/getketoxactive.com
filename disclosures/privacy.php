...
<html><head>
	...
	<style type="text/css">
		...
		li{margin:10px 0; font-size:12px; line-height:20px;}
	</style>
</head>
...
<div class="terms-block">
    ...
    <h1>Privacy Policy (effective 01-01-2022)</h1>

    <p>Within the Privacy Policy, the operator of this Web site ("Website")&nbsp;<?php echo $configs->corp_name; ?>&nbsp;will be
        referred to as "Company", "we" or "us". We are committed to complete permission-based marketing,
        while safeguarding your privacy online. Please read our privacy policy ("Policy") to understand
    ...
    <p>As part of offering and providing customizable and personalized services, the Company may use
        ...
        on our website.&nbsp;
        <br>Generally, we use cookies to:</p>
    <ul>
        <li>(1) Remind us of who you are and to access your registration preferences to deliver to you a
            better and more personalized service. Cookies enable us to retain our user’s preferences on
            the Website without having to re-enter information every time they access the Website.&nbsp;</li>
        <li>(2) Estimate our audience size. Each browser accessing the Website is given a unique cookie
            ...
            trail" and may also describe which pages you have seen.&nbsp;</li>
        <li> (3) Measure certain traffic patterns, which areas of the Company web site you have visited,
    ...
    <p>By entering a sweepstakes or promotion, registering with our Website, completing any forms on our
    ...
    <p>To the extent that credit card-specific information is collected at the Website and any of our
    ...
    <p>Users may receive email confirming their registration with the Website, co-registration with
    ...
    <h4>Unpermitted use&nbsp;</h4>

    <p>INDIVIDUALS UNDER 18 YEARS OF AGE ARE NOT ALLOWED TO PARTICIPATE IN ANY SWEEPSTAKE OR PROMOTION
    ...
    <p>By accessing this Website and/or submitting any information to us, you agree to this policy. We
    ...
    <h4>Wireless Policy to add to existing Terms of Use/Privacy Policy</h4>

    <p>We may use personal information to provide the services you've requested, including services that
    ...
    <p> Data obtained from you in connection with this SMS service may include your name, address, cell
        ...
        used by us or third parties to send promotional correspondence to you.
    </p>
    
    <h4>Digital Millennium Copyright Act</h4>

    <p>THIS NOTICE IS SUBJECT TO MODIFICATION OR TERMINATION AT ANY TIME, WHETHER FOR CHANGES IN THE LAW
    ...
    <p>Please refer to the following detailed instructions which must be followed to protect your rights
    ...
    <ul>
        <li>1. A physical or electronic signature of a person authorized to act on behalf of the owner
            of an exclusive right that is allegedly infringed.
        </li><li>2. Identify in sufficient detail the location of copyrighted work that you believe has been
        ...
        <li>4. Information reasonably sufficient to permit us to contact the complaining party, such as
            an address, telephone number, and, if available, an electronic mail address at which the
            complaining party may be contacted.</li>
        
        <li>5. The following statement: "I have a good faith belief that use of the material in the
            manner complained of is not authorized by the copyright owner, its agent, or the law."</li>
        
        <li>6. The following statement: "I swear, under penalty of perjury, that the information in the
