...
<html><head>
	...
	<style type="text/css">
		body{font-family:Tahoma, Geneva, sans-serif; margin:0; padding:15px;}
		p{color:#000; font-size:12px; line-height:20px; margin:15px 0 0 0;}
		h1{font-size:22px; margin:0 0 10px 0;}
		h4{font-size:18px; margin:25px 0 0 0;}
		li{margin:10px 0; font-size:14px; line-height:20px;}
	</style>
</head>
...
<div class="popup-inner">
        ...
        <p>1.1 You expressly agree and accept the Conditions set forth herein unconditionally as a binding
            contract ("the Agreement") enforceable by law. The following are the terms and conditions of
            participation in the <?php echo $configs->corp_name; ?>, Subscription ("Subscription") or any other Product on this Site, all
            such references to Subscription or Product combined shall be ("Product"). "Customer", "I", "You" or
            "Your" refers to you. "Site" means this World Wide Website located at the URL or <?php echo $configs->corp_name; ?>
            , ("We", "Us" or "Our") reserves the right to amend this Agreement from time to time. It
            is agreed that any such amendment will apply to Customer. <?php echo $configs->corp_name; ?> agrees to inform
        ...
        <p>2.1 All product purchases made from this website are required to be paid in full.
            <br><br>2.1.1. The prices for the products are as follows:$<?php echo number_format($configs->bottle_price_5,2);  ?>(+ free S&amp;H) for the 5 bottle package
            ($<?php echo number_format($configs->bottle_per_5,2);  ?> bottle);$<?php echo number_format($configs->bottle_price_3,2);  ?> (+ free S&amp;H) for the 3 bottle package ($<?php echo number_format($configs->bottle_per_3,2);  ?> bottle);$<?php echo number_format($configs->bottle_price_1,2);  ?> (+$<?php echo number_format($configs->bottle_price_1_total,2);  ?> S&amp;H)
            for the  bottle package ($<?php echo number_format($configs->bottle_per_1,2); ?> bottle).
            <br><br>2.3.1 You authorize us to initiate a charge to your credit card as indicated upon your
            purchase.
						<br><br>2.3.1 (Cont) This product is sold as a program with the price and product being charged and delivered one the initial sale, and then again monthly (every 30 days after the initial purchase). Depending on the selected number of products upon initial purchase, the price per installment will vary. For 2 bottle, each installment is $<?php echo number_format($configs->bottle_price_1,2);  ?> . For 3 bottles, each installment is $<?php echo number_format($configs->bottle_price_3,2);  ?> and for 5 bottles, each installment is $<?php echo number_format($configs->bottle_price_5,2);  ?>. The program begins when the customer signs up, and continues indefinitely until the customer shall chose to cancel. The secondary product is optionally sold as a single bottle add on purchase with the initial order only.
            <br><br>2.3.2 Your product will ship within 24 hours and will arrive within 5-7 business days. If your
            ...
            <br><br>2.4 Please contact Customer service at TOLL FREE&nbsp;<span class="phone-line"><?php echo $configs->customer_service_number; ?></span> between the hours of <?php echo $configs->cs_hours; ?> with any questions regarding your product, payment or return.
            <br><br>2.5.1 Additional Opt-in Product: <?php echo $configs->step2_name ?>, if purchased, will be shipped within 24 hours and arrive
            within 5-7 business days. You are ordering a 30 day supply and will be charged$<?php echo number_format($configs->upsell_price,2);  ?> (+ free S&amp;H) for the
            product you receive. This purchase is backed by a 100% Money Back Guarantee. If at some point you choose to
            cancel this purchase, call customer service at <span class="phone-line"><?php echo $configs->customer_service_number; ?></span> anytime between <?php echo $configs->cs_hours; ?>.
        </p>

        <h4>3. RETURNS, CANCELLATION, AND REFUND POLICY
            REFUND POLICY.</h4>

        <p> 3.1 In order to be considered for a refund, you must call Customer Service at TOLL FREE <span class="phone-line"><?php echo $configs->customer_service_number; ?></span>
            ...
            <br><br>3.2 Persons with a medical condition, who are pregnant, or have reason to believe they may become
            ...
            <br><br>3.3 All processed orders are subject to a 9.95 processing fee if the charge for the
            product/order has settled.
            <br><br>3.4 All returns are subject to a restocking fee. Accordingly all products have a 8.95 restocking
            fee, per item, if returned unopened and in good condition.
        </p>
        <h4>4. DISPUTE RESOLUTION</h4>

        <p>4.1 If you have any dispute concerning any aspect of these Terms of Website Use, the Website, or any
            ...
            <br><br>4.2 Opt-Out of Arbitration/Class Action Waiver. The Terms &amp; Conditions do not constitute a
            ...
            <br><br>4.3 YOU ACKNOWLEDGE AND AGREE THAT, VIA YOUR ACCEPTANCE OF THESE DISPUTE RESOLUTION PROVISIONS,
            ...
            <br><br>4.4 You agree to indemnify for any financial harm or any losses caused by Your objections to
            ...
            Agreement.
            <br><br>4.5 Credit Card Billing Customer expressly agrees that if Customer pays by credit card, check or
        ...
        <p>5.1 While we make every effort to ensure that items appearing on the Site are available, we cannot
            ...
            <br><br>5.2 An order submitted by You constitutes an offer by You to Us to purchase the Subscription on
            these Conditions and is subject to Our subsequent acceptance.
            <br><br>5.3 Prior to such acceptance, an automatic e-mail acknowledgement of Your order may be
            generated. Please note that any such automatic acknowledgement does not constitute a formal
            acceptance of Your order.&nbsp;
            <br><br>5.4 Our acceptance of Your order takes effect and the contract concluded at the point where such
            offer is expressly accepted by Us dispatching Your order and accepting Your credit card or other
            payment ("Acceptance").&nbsp;
            <br><br>5.5 We may keep records of orders received, acknowledgements, acceptances and other contract
        ...
        <p>6.1 You represent that the information provided by You when placing Your order is up-to-date,
            ...
            <br><br>6.2 No warranty, commitment or any other obligation should ever be assumed by You on Our behalf
            or on behalf of a Product manufacturer, license or supplier without Our express prior written
            consent.
            <br><br>6.3 PRICE AND TERMS OF PAYMENT (NOTE: WE CANNOT CONFIRM PRICES PRIOR TO ACCEPTANCE OF YOUR
            ORDER)
            <br><br>6.4 Prices payable for the Product are those in effect at the time of dispatch or delivery,
            ...
            Our Acceptance.
            <br><br>6.5 We have the right at any time prior to Our Acceptance to withdraw any discount and/or to
            ...
            <br><br>6.6 The places that we deliver to are listed on the Site ("Territory"). Unless otherwise
            ...
            <br><br>6.7 You agree to pay for taxes, shipping or carriage of Products as such costs are specified by
            ...
            <br><br>6.8 Except as expressly provided elsewhere in these Conditions or the Site, payment may be taken
            in full notwithstanding any claim for short delivery or defects.
            <br>6.9 We will charge credit or debit cards on dispatch of the Product or commencement of Services.
            We reserve the right to verify credit or debit card payments prior to Acceptance.
            <br><br>6.10 If at any time you fail to pay any amount due on the relevant due date, or we are unable to
        ...
        <p>7.1 If You commit an act of bankruptcy or enter into a deed of arrangement with creditors or a court
            ...
            <br><br>7.1.4 By written notice, terminate Your order and all or any other contracts between Us and
            You.&nbsp;</p>

        <h4>8. DELIVERY AND RISK</h4>

        <p>8.1 Delivery timescales/dates specified on the Site, in any order acknowledgement, acceptance or
            ...
            KNOW.
            <br><br>8.2 Delivery shall be to a valid address within the Territory submitted by You and subject to
            ...
            submit an order.
            <br><br>8.3 If You refuse or fail to take delivery of Products provided in accordance with these
            ...
            <br><br>8.3.1 We shall be entitled to immediate payment in full for the Products or Services delivered
            and either to effect delivery by whatever means We consider appropriate or to store Products at Your
            risk;
            <br><br>8.3.2 You shall be liable pay on demand all costs of Product storage and any additional costs
            incurred as a result of such refusal or failure to take delivery; and
            <br>8.3.3 We shall be entitled 30 days after the agreed date for delivery to dispose of Products in
            such manner as We determine and may set off any proceeds of sale against any sums due from You.
            <br><br>8.4 Except to the extent required as a result of any mandatory rights You have as a consumer
            ...
            <br><br>8.5 Where We deliver Products by installments, each installment constitutes a separate contract
            ...
            <br><br>8.6 Save as otherwise provided in these Conditions, risk of loss of or damage to the Products
        ...
        <p>9.1 Except as set out above and subject to any rights You have under applicable law that cannot be
            excluded or limited by these Conditions:
            <br><br>9.1.1 We shall not be liable and You shall not be entitled to reject Products or Services,
            ...
            apparent.
            <br><br>9.1.2 We shall not be liable for any damage or losses arising from the use of the Products in
            ...
            <br><br>9.1.3 Where these is a shortage or failure to deliver, or any defect in or damage to a Product
        ...
        <p>10.1 TO THE MAXIMUM EXTENT LEGALLY PERMITTED, WHETHER OR NOT WE WERE AWARE OR ADVISED OF THE
            ...
            <br><br> 10.2 <?php echo $configs->corp_name; ?>, in its sole discretion, shall not be liable for a chance occurrence
        ...
        <p>11.1 You shall indemnify Us against any and all liabilities, claims and costs incurred by or made
            ...
            third party.
            <br><br>11.2 To the fullest extent permitted by law, we shall have no liability to You in the event the
        ...
        <h4> 12. WARRANTY "AS IS" IN GENERAL – WITHOUT REGARD TO SEPARATE WARRANTY STATEMENTS PACKAGED BY THE
            MANUFACTURER WITH THE PRODUCTS.</h4>

        <p>12.1 All Product specifications, illustrations, drawings, particulars, dimensions, performance data
            ...
            <br><br>12.2 You will have the benefit of the manufacturer's, licensor's or supplier's warranty with the
            Products supplied and should refer to the relevant documentation supplied with the Product in this
            regard.
            <br><br>12.3 Your rights of repair or replacement of any Products or any part or parts thereof which are
            found to be defective will (except where agreed otherwise) be negated or rendered void where:
            <br><br>12.3.1 Products have been repaired or altered by persons other than the manufacturer, us or any
            authorized dealer; and/or
            <br><br>12.3.2 Defective Product or Products have not been returned together with full details in
            writing of the alleged defects within 30 days from the date on which such Products were delivered;
            and/or
            <br><br>12.3.3 Defects are due (wholly or partially) to mistreatment, improper use or storage or
            ...
            <br><br>12.4 EXCEPT AS EXPRESSLY STATED OTHERWISE IN THIS SECTION 12, WE MAKE NO EXPRESS WARRANTIES OR
        ...
        <p>13.1 By clicking “ORDER NOW,” I am agreeing to receive text messages from <?php echo $configs->corp_name; ?> and
            business partners. I provide my signature expressly consenting to recurring contact from <?php echo $configs->corp_name; ?>
            ...
            <br><br>13.2 If any license or consent of any government or other authority is required for the
            ...
            <br><br>13.3 Products licensed or sold to you under these Conditions may be subject to export control
            ...
            them.
            <br><br>13.4 Items entering the European Economic Area (EEA) from outside over a certain value may be
        ...
        <p>14.1 Any notice or other communications in relation to Our contract may be given by sending the same
            ...
            <br><br>14.1.1 In relation to hand delivery, on the date of delivery at the relevant address (or, if
            ...
            <br><br>14.1.3 If sent by email, on the earliest of (i) the email being acknowledged by the recipient as
        ...
        <p>15.1 We will observe applicable data protection laws and will not use information that does or can be
        ...
        <p>16.1 You shall not assign, transfer, charge or make over or purport to assign transfer charge to make
            over Your rights under these Conditions. Any purported assignment shall be null and void.
            <br><br>16.2 We shall not be liable to You nor held in breach of contract for any loss or damage which
            ...
            <br><br>16.3 You acknowledge that these Conditions supersede and cancel all previous contracts,
            ...
            <br><br>16.4 No relaxation, forbearance, delay or indulgence by either You or Us in enforcing any of
            these Conditions or the granting of time by either party to the other shall prejudice or restrict
            such rights and powers.
            <br><br>16.5 No waiver of any term or condition of these Conditions shall be effective unless made in
            ...
            <br><br>16.6 If for any reason We determine or a court of competent jurisdiction finds that any
            provision or portion of these Conditions to be illegal, unenforceable, or invalid under applicable
            law in a particular jurisdiction:
            <br><br>16.6.1 These Conditions will not be affected in other jurisdictions to the extent that such
            determination or finding has no application; and
            <br><br>16.6.2 In the relevant jurisdiction, the remainder of these Conditions (to the fullest extent
            permitted by law) will continue in full force and effect.
        </p>
        
        <h4>17. GOVERNING LAW&nbsp;</h4>

        <p>17.1 The construction validity and performance of these Conditions shall be governed by US Law and
